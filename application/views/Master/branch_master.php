...
<div class="row p-3">
           ...
           <select name="branch" id="branch"  -control="select2" -hide-search="true" class="js-states form-control nav selectpicker">
       ...
       <div class="col-sm-12 col-md-6 col-lg-3 form-group custom-dropdown  ">
           <label for="">Enter Branch Head Name </label>
           <select name="dept_head" id="dept_head"  -control="select2" -hide-search="true" class="js-states form-control nav selectpicker">
           <option selected disabled  value="0"></option>
           <option value="BSC">BSC</option>
           <option value="2">BCOM</option>
            <option value="3">BCA</option>
