...
<div class="row p-3">
                                       ...
                                       <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3  form-group  ">
                                            <label for=""> Enter term Name </label>
                                            <input class="form-control" id="term_name" type="text" placeholder=" "  name="term_name" />
                                        </div> 
           ...
           <label for="">Select Stream Type </label>
           <select name="stream" id="stream"  -control="select2" -hide-search="true" class="js-states form-control nav selectpicker">
           <option selected disabled  value="0"></option>
