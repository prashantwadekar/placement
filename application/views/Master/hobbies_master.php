...
<div class="row p-3">
                                       ...
                                       <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3  form-group  ">
                                            <label for=""> Enter Hobbies </label>
                                            <input class="form-control" id="hobbies" type="text" placeholder=" "  name="hobbies" />
                                        </div> 
...
<script  src="<?php echo base_url('web_resources');?>/dist/js/controllers/hobbies.js"></script>