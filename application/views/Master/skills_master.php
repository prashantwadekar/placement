...
<div class="row p-3">
                                       ...
                                       <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3  form-group  ">
                                            ...
                                            <input class="form-control" id="skills" type="text" placeholder=" "  name="skills" />
                                        </div> 
...
<script  src="<?php echo base_url('web_resources');?>/dist/js/controllers/skills_master.js"></script>