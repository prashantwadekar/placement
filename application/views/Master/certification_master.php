...
<div class="row p-3">
                                       ...
                                       <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3  form-group  ">
                                            <label for=""> Enter Certification Name </label>
                                            <input class="form-control" id="cert_name" type="text" placeholder=" "  name="cert_name" />
                                        </div> 
        
                                        
                                        <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3  form-group  ">
                                            <label for=""> Description </label>
                                            <textarea class="form-control" rows="4" id="description" type="text" placeholder=" "  name="description" ></textarea>
                                        </div>
    ...
    <div class="col-md-12 text-right">
                                            ...
                                            <button class="btn btn-warning text-white" type="button" name="cancle" id="cancle"><a href="<?=base_url();?>Opening/create"><i class="fa-sharp fa-solid fa-pen-to-square"></i> Edit</button>
...
<script  src="<?php echo base_url('web_resources');?>/dist/js/controllers/certification.js"></script>