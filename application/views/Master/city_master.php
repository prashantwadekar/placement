...
<div class="row p-3">
                                       ...
                                       <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3  form-group  ">
                                            ...
                                            <input class="form-control" id="city_name" type="text" placeholder=" "  name="city_name" />
                                        </div>                                                                         
...
<script  src="<?php echo base_url('web_resources');?>/dist/js/controllers/city_master.js"></script>