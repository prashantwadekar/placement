...
<div class="row p-3">
                                       ...
                                       <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3  form-group  ">
                                            <label for=""> Enter Stream Type Name </label>
                                            <input class="form-control" id="streamtype" type="text" placeholder=" "  name="streamtype" />
                                        </div>                                                                         
...
<script  src="<?php echo base_url('web_resources');?>/dist/js/controllers/stream_master.js"></script>