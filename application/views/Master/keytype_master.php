...
<div class="row p-3">
                                       ...
                                       <!-- <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3  form-group  ">
                                            <label for=""> Enter Keyword Name </label>
           ...
           <label for="">Select Keyword Type </label>
           <select name="keyword" id="keyword" class="js-states form-control" multiple="multiple">
...
<script  src="<?php echo base_url('web_resources');?>/dist/js/controllers/keyword_type.js"></script>