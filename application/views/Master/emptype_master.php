...
<div class="row p-3">
                                       ...
                                       <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3  form-group  ">
                                            <label for=""> Enter Employee Type </label>
                                            <input class="form-control" id="employee_type" type="text" placeholder=" "  name="employee_type" />
                                        </div>                                                                         
...
<script  src="<?php echo base_url('web_resources');?>/dist/js/controllers/Employee_type.js"></script>