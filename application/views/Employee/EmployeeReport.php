...
$(document).ready(function() {
    $('#example').DataTable( { 
      ...
      "ajax" : "<?php echo base_url('Employee/ReportfetchDatafromDatabase'); ?>",
				"order": [],      
         responsive: true,
         dom: 'Bfrtip',
         dom: 'lBfrtip',
...
function PrintDiv() {    
   ...
   divToPrint += '<thead><tr><th>ID</th><th>Full Name</th><th>Email</th><th>Phone</th><th>Pincode</th></tr></thead>';
