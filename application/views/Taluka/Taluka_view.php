                                ...
                                <form role="form" id="Form" action="" method="post">
                                 <div class="row">
                                    ...
                                    <div class="col-lg-2 form-group mb-3">
                                        ...
                                        <option data-talukaCode="DZ" >0.Devgad</option>
                                        <option data-talukaCode="AD" >1.Malwan</option>
                                        <option data-talukaCode="AO" >2.Niphad</option>
                                        <option data-talukaCode="AI" >3.Amalner</option>
                                        <option data-talukaCode="AG" >4.Arvi</option>
                                        <option data-talukaCode="AR" >5.Wadwani</option>
                                        <option data-talukaCode="AM" >6.Rahuri</option>
                                        </optgroup>
                                        </select>
                                    </div>
