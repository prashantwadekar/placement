...
<div class="row p-3">
                                    ...
                                    <div class="col-xs-4 col-sm-4 col-md-12 col-lg-3 form-group gap  mt-0">
                                            ...
                                            <input class="form-control" id="std_fathername" type="text" placeholder=" " name="std_fathername" value="<?php echo $result[0]->std_fathername; ?>"  disabled />
                                    </div>    
                                    <div class=" col-xs-4 col-sm-4 col-md-12 col-lg-3  form-group  mt-0">
                                            <label for=""> Mother Name <c></c></label>
                                            <input class="form-control" id="std_mothername" type="text" placeholder=" " name="std_mothername" value="<?php echo $result[0]->std_mothername; ?>"  disabled />
                                        </div>                              
</div>
...
<div class="col-xs-4 col-sm-4 col-md-12 col-lg-3 form-group gap  mt-0">
                                            ...
                                            <input class="form-control" id="std_dob" type="date" value="<?php echo $result[0]->std_dob; ?>"  disabled  name="std_dob"/>
                                        </div>
                                        <div class="col-xs-4 col-sm-4 col-md-12 col-lg-3 form-group gap  mt-0">
                                            <label for="">Age<c></c></label>
                                            <input class="form-control" id="std_age" type="text" placeholder=" " value="<?php echo $result[0]->std_age; ?>"  disabled  name="std_age"  />
                                        </div> 
                                        <div class="col-xs-4 col-sm-4 col-md-12 col-lg-3 form-group  mt-0">
                                        <label for="picker1">Gender <c></c></label>
                                        <div class="d-flex ">
                                           <label class="radio radio-primary  mt-0">    </label>
                                         <input type="radio" name="std_gender" value="male" disabled <?php echo ($result[0]->std_gender == '1') ? 'checked' : ''; ?>><span class="pr-1  " style="color:#0161b5;">&nbsp;Male</span><span class="checkmark"></span>
                                         <label class="radio radio-primary"></label>&nbsp;
                                         <input type="radio" name="std_gender" value="female" disabled <?php echo ($result[0]->std_gender == '2') ? 'checked' : ''; ?>><span class="pr-1" style="color:#0161b5;">&nbsp;Female</span><span class="checkmark"></span>
                                         <label class="radio radio-primary"></label>
                                        <input type="radio" name="std_gender" value="other" disabled<?php echo ($result[0]->std_gender == '3') ? 'checked' : ''; ?>><span class="pr-1" style="color:#0161b5;">&nbsp;Other</span><span class="checkmark"></span>
                                        </div>
                                        <input type="hidden" name="std_id" value="<?php echo $result[0]->std_id; ?>">
                                     </div>
...
<div class="row p-3">
                                     ...
                                     <div class="col-xs-4 col-sm-4 col-md-12 col-lg-3 form-group gap  mt-0">
                                           <label for="phone">Mobile No. <c></c></label>
                                            <input class="form-control" id="std_mobileno" type="tel" maxlength="10" placeholder="" name="std_mobileno" value="<?php echo $result[0]->std_mobileno; ?>"  disabled />
                                        </div>
    ...
    <?php foreach ($religion_types as $religion_type): ?>
        <option disabled value="<?php echo $religion_type->id; ?>" <?php if ($religion_type->id == $result[0]->std_religion) { echo 'selected'; } ?>><?php echo $religion_type->religion; ?></option>
    <?php endforeach; ?>
           </select>
        </div>
    ...
    <?php foreach ($cast_types as $cast_types): ?>
        <option disabled value="<?php echo $cast_types->id; ?>" <?php if ($cast_types->id == $result[0]->std_cast) { echo 'selected'; } ?>><?php echo $cast_types->cast; ?></option>
    <?php endforeach; ?>
           </select>
         </div>
</div>
...
<div class="col-xs-4 col-sm-4 col-md-12 col-lg-3 form-group gap  mt-0">
    ...
    <?php foreach ($subcast_types as $subcast_types): ?>
        <option disabled value="<?php echo $subcast_types->id; ?>" <?php if ($subcast_types->id == $result[0]->std_subcast) { echo 'selected'; } ?>><?php echo $subcast_types->subcast; ?></option>
    <?php endforeach; ?>
           </select>
         </div>
         ...
         <div class="col-xs-4 col-sm-4 col-md-12 col-lg-3 form-group gap   mt-0">
            ...
            <input class="form-control adhar" id="std_adharnumber" type="text" placeholder="" name="std_adharnumber" value="<?php echo $result[0]->std_adharnumber; ?>" maxlength="12" disabled/>
        </div>
        <div class="d-none d-lg-block d-xl-block col-lg-3 photo">
...
<div class="col-xs-4 col-sm-4 col-md-12 col-lg-3 form-group gap  custom-dropdown  mt-0">
    ...
    <?php foreach ($appliedfor_types as $appliedfor_type): ?>
        <option  value="<?php echo $appliedfor_type->id; ?>" <?php if ($appliedfor_type->id == $result[0]->std_appliedfor) { echo 'selected'; } ?>><?php echo $appliedfor_type->applied; ?></option>
    ...
    <?php foreach ($qualification_types as $qualification_type): ?>
        <option  value="<?php echo $qualification_type->id; ?>" <?php if ($qualification_type->id == $result[0]->std_qualification) { echo 'selected'; } ?>><?php echo $qualification_type->qualification; ?></option>
    ...
    <?php foreach ($department_types as $department_types): ?>
        <option  value="<?php echo $department_types->id; ?>" <?php if ($department_types->id == $result[0]->std_department) { echo 'selected'; } ?>><?php echo $department_types->department; ?></option>
...
<div class="row p-3">
  ...
  <option selected disabled  value="0"></option>
    ...
    <?php foreach ($branch_types as $branch_types): ?>
        <option value="<?php echo $branch_types->id; ?>" <?php if ($branch_types->id == $result[0]->std_branch) { echo 'selected'; } ?>><?php echo $branch_types->branch; ?></option>
    ...
    <?php foreach ($degree_types as $degree_types): ?>
        <option disabled value="<?php echo $degree_types->id; ?>" <?php if ($degree_types->id == $result[0]->std_degree) { echo 'selected'; } ?>><?php echo $degree_types->degree; ?></option>
...
<div class="col-xs-4 col-sm-4 col-md-12 col-lg-3 form-group gap  mt-0">
           <label for="">Degree %<c></c></label>
            <input class="form-control" id="std_degreeper" type="text" placeholder=" " name="std_degreeper" value="<?php echo $result[0]->std_degreeper; ?>" disabled/>
        </div>
        <div class="col-xs-4 col-sm-4 col-md-12 col-lg-3 form-group gap  custom-dropdown  mt-0">
    ...
    <?php foreach ($master_types as $master_types): ?>
        <option disabled value="<?php echo $master_types->id; ?>" <?php if ($master_types->id == $result[0]->std_master) { echo 'selected'; } ?>><?php echo $master_types->master; ?></option>
    ...
    <?php endforeach; ?>
       ...
       <div class="col-xs-4 col-sm-4 col-md-12 col-lg-3 form-group   mt-0">
           <label for="">Master %<c></c></label>
            <input class="form-control" id="std_masterper" type="text" placeholder=" " name="std_masterper" value="<?php echo $result[0]->std_masterper; ?>" disabled/>
        </div>
</div>
<div class="row p-3">
<div class="col-xs-4 col-sm-4 col-md-12 col-lg-3 form-group gap  mt-1">
           <label for="">Country <c></c></label>
           <select name="std_country" id="std_country" data-control="select2" data-hide-search="true" class="js-states form-control nav selectpicker">
    <option disabled selected value="0"></option>
    <?php foreach ($country_types as $country_type): ?>
        <option disabled value="<?php echo $country_type->id; ?>" <?php if ($country_type->id == $result[0]->std_country) { echo 'selected'; } ?>><?php echo $country_type->country; ?></option>
    <?php endforeach; ?>
</select>
       </div>
       <div class="col-xs-4 col-sm-4 col-md-12 col-lg-3 form-group gap  custom-dropdown  mt-0">
    ...
    <?php foreach ($state_types as $state_types): ?>
        <option disabled value="<?php echo $state_types->id; ?>" <?php if ($state_types->id == $result[0]->std_state) { echo 'selected'; } ?>><?php echo $state_types->state; ?></option>
    ...
    <?php foreach ($city_types as $city_types): ?>
        <option disabled value="<?php echo $city_types->id; ?>" <?php if ($city_types->id == $result[0]->std_city) { echo 'selected'; } ?>><?php echo $city_types->city; ?></option>
...
<div class="col-xs-4 col-sm-4 col-md-12 col-lg-6 form-group gap  mt-0">
            ...
            <textarea class="form-control" id="std_address" type="text" placeholder="" name="std_address" disabled><?php echo $result[0]->std_address; ?></textarea>
        </div>
<div class="col-xs-4 col-sm-4 col-md-12 col-lg-3 form-group  mt-0 mb-2">
            <label for="phone">Pincode <c></c></label>
            <input class="form-control" id="std_pincode" type="text" maxlength="6" placeholder="" name="std_pincode" value="<?php echo $result[0]->std_pincode; ?>"  disabled/>
        </div>
...
<div class="col-xs-4 col-sm-4 col-md-12 col-lg-9 form-group  custom-dropdown ">
        ...
        <?php foreach ($hobbie_types as $hobbie_type): ?>
            <?php $selected = (in_array($hobbie_type->id, explode(',', $result[0]->std_hobbies))) ? 'selected' : ''; ?>
            <option disabled value="<?php echo $hobbie_type->id; ?>" <?php echo $selected; ?>><?php echo $hobbie_type->hobbie; ?></option>
        <?php endforeach; ?>
    </select>
       </div>
</div>
...
<div class="col-xs-4 col-sm-4 col-md-12 col-lg-9 form-group   custom-dropdown">
        ...
        <?php foreach ($skill_types as $skill_type): ?>
            <?php $selected = (in_array($skill_type->id, explode(',', $result[0]->std_skills))) ? 'selected' : ''; ?>
            <option disabled value="<?php echo $skill_type->id; ?>" <?php echo $selected; ?>><?php echo $skill_type->skill; ?></option>
        <?php endforeach; ?>
    </select>
       </div> 
</div>
...
<div class="col-xs-8 col-sm-8 col-md-12 col-lg-9 form-group custom-dropdown  mt-0">
    ...
    <?php foreach ($cerification_types as $cerification_types): ?>
        <?php $selected = (in_array($cerification_types->id, explode(',', $result[0]->std_certification))) ? 'selected' : ''; ?>
        <option disabled value="<?php echo $cerification_types->id; ?>"<?php echo $selected; ?>><?php echo $cerification_types->cerification; ?></option>
    <?php endforeach; ?>
           </select>
       </div>
</div>
