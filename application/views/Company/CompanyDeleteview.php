...
$(document).ready(function() {
    $('#example').DataTable( { 
      ...
      "ajax" : "<?php echo base_url('Company/DeletefetchDatafromDatabase'); ?>",
				"order": [],
		...
		function deleteFun(com_id)
		{
			Swal.fire({
			  ...
			  if (result.isConfirmed) {
				$.ajax({
					url:'<?php echo base_url('Company/deleteSingleData'); ?>',
					method:"post",
					dataType:"json",
					data:{com_id:com_id},
...
//edit function start here
		...
		{
			$.ajax({
				url: "<?php echo base_url('Company/getEditData'); ?>",
				method:"post",
        data:{std_id:std_id},
				dataType:"json",
				success:function(response)
