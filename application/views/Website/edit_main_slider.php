...
<body>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <thead>
                                      ...
                                      <button type="button" class=" btn Addnew"><a href="mainslider"><i class="fas fa-plus-circle animtxt" aria-hidden="true"></i>&nbsp;Add New</a></button>
                                      </div>
            <tr>
            <th>Action</th>
              <th>Sr.No</th>            
                <th>Slider Label </th>
                <th>Slider Web Image</th>
        ...
        <tbody>
            <tr>
            <td><i class="far fa-edit fa-lg"style="color:#1977D3;"></i><a  href="mainslider" data-mdb-toggle="tooltip" title="edit">&nbsp;Edit</a></td>
              <td>01</td>
                <td>INT Off campus</td>
                <td>1.png</td>
                <td>2.png</td>
                <td>25/09/1990</td>
                <td>25/09/1990</td>
