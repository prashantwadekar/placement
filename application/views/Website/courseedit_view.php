              ...
              <div class="breadcrumb">
                ...
                <div class="row card p-3">
                    <div class="col-12">
                        ...
                        <form id="Form" action="<?php echo site_url('Website/update'); ?>" method="POST">
<div class="row p-3">
           ...
           <option value="2">Electronics</option>
            <option value="3">Other</option>
                                       ...
                                       <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3  form-group  mt-0">
                                            ...
                                            <input class="form-control" id="coursename" type="text" placeholder=" "  name="coursename" value="<?php echo $result[0]->coursename; ?>"/>
                                        </div>                                                                         

                                        <div class="col-sm-12 col-md-6 col-lg-2 form-group  mt-0">
                                           <label for="duration">Duration <c>*</c></label>
                                            <input class="form-control" id="duration" type="tel" maxlength="10" placeholder="" name="duration" value="<?php echo $result[0]->duration; ?>"/>
                                        </div>
...
<div class="row  p-3">
        ...
        <div class="col-sm-12 col-md-12 col-lg-3  col-xl-3 form-group  mt-0">
            ...
            <textarea class="form-control" id="description" type="text" placeholder="" name="description"></textarea>
        </div>
    ...
    <button class="btn btn-md btn-success btnright text-white" type="button" name="btn_save"  id="btn_save"><i class="nav-icon fa-regular fa-circle-check "></i> Update</button>
                                            <button class="btn btn-md btn-danger btnedit text-white" type="button" name="cancle" id="cancle"><a href="../modifycourse" style="color:white;"><i class="fa-sharp fa-solid fa-pen-to-square"></i> Cancel</button>
...
<script  src="<?php echo base_url('web_resources');?>/dist/js/controllers/editcourse.js"></script>
