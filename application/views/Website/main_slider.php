...
<div class="row p-3">
       ...
       <div class="col-sm-12 col-md-6 col-lg-2 col-xl-2 fdwn fform-group ">
            <label for="phone">Slider Web Image  </label>
...
<div class="row">
    ...
    <div class="col-md-12 text-right">
                                            ...
                                            <button class="btn btn-md btn-warning text-white" type="button" name="cancle" id="cancle"><i class="fa-sharp fa-solid fa-pen-to-square"><a href="editmainslider" style="color:white;"></i> Edit</button>
