                            ...
                            <div class="card-body">
                                <form role="form" id="Form" action="" method="post">
                                    ...
                                    <div class="col-md-3 mt-3 inputBox form-group mb-3">
                                          <input type="text" id="Districtname" name="Districtname" required onkeyup="this.setAttribute('value', this.value);" value="" />
                                            <label>District name</label>
                                        </div>
                                        <div class="col-md-3 mt-3 inputBox form-group mb-3">
                                          <input type="text" id="DistrictShortname" name="DistrictShortname" required onkeyup="this.setAttribute('value', this.value);" value="" />
                                            <label>District Short name</label>
                                        </div>
                                        
                                        <div class="col-md-3 mt-3 inputBox form-group mb-3">
                                          <input type="text" id="DistrictCode" name="DistrictCode" required onkeyup="this.setAttribute('value', this.value);" value="" />
