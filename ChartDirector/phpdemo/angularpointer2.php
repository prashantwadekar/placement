...
$m->addPointer2(9, 0x3f00ff00, -1, LinePointer2);

# Add a semi-transparent blue (0x7f66aaff) triangular pointer floating between 60% and 85% of the
# scale radius with the pointer width 5 times the default
$m->addPointer2(52, 0x7f66aaff, 0x66aaff, TriangularPointer2, 0.6, 0.85, 5);

# Add a semi-transparent yellow (0x7fffff66) triangular pointer floating between 80% and 90% of the
# scale radius with the pointer width 5 times the default
$m->addPointer2(65, 0x7fffff66, 0xffff66, TriangularPointer2, 0.8, 0.9, 5);

# Add two red (0xff0000) triangular pointer at 72 and 94. The pointers float between 110% and 100%
# of the scale radius with widths 3 times the default
$m->addPointer2(72, 0xff0000, -1, TriangularPointer2, 1.1, 1.0, 3);
$m->addPointer2(94, 0xff0000, -1, TriangularPointer2, 1.1, 1.0, 3);
