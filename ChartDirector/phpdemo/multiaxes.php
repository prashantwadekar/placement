...
# Data for the chart
$data0 = array(1700, 3900, 2900, 3800, 4100, 4600, 2900, 4100, 4400, 5700, 5900, 5200, 3700, 3400,
    5100, 5600, 5600, 6000, 7000, 7600, 6300, 6700, 7500, 6400, 8800);
$data1 = array(500, 550, 670, 990, 820, 730, 800, 720, 730, 790, 860, 800, 840, 680, 740, 890, 680,
    790, 730, 770, 840, 820, 800, 840, 670);
$data2 = array(46, 68, 35, 33, 38, 20, 12, 18, 15, 23, 30, 24, 28, 15, 21, 26, 46, 42, 38, 25, 23,
    32, 24, 20, 25);
$data3 = array(0.84, 0.82, 0.82, 0.38, 0.25, 0.52, 0.54, 0.52, 0.38, 0.51, 0.46, 0.29, 0.5, 0.55,
...
$title = $c->addTitle("Multiple Axes Demonstration", "Arial Bold Italic", 15);
...
$legendBox = $c->addLegend(300, 80, false, "Arial Bold", 8);
...
$viewer->setImageMap($c->getHTMLImageMap("", "", "title='{dataSetName} at hour {xLabel} = {value}'")
    );
?>
