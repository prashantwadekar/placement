...
$boxTop = (new ArrayMath($data))->insert2(0, 1, count($data))->acc()->result();
...
$boxBottom = (new ArrayMath($boxTop))->shift(1, 0)->result();
...
$viewer->setImageMap($c->getHTMLImageMap("", "", "title='{xLabel}: {={top}-{bottom}} millions'"));
?>
